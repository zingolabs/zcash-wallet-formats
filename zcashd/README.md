...
## Primitive Data Serialization Reference
...
| uint256                              | 256-bit unsigned integer or hash    | Little-endian, 32 bytes                                                     |
| <span id="vector">`vector<T>`</span> | Dynamic array of elements of type T | [`uint32_t`](#uint32_t) (length in elements) + elements serialized in order |
...
| <span id="CPrivKey">`CPrivKey`</span>                                                               | Serialized private key, with all parameters included.              | `unsigned char[279]` (private key, serialized as a DER ECPrivateKey type from section C.4 of SEC 1)[^3]                                                                                                                    |
...
| <span id="CMasterKey">`CMasterKey`</span> (WIP: what is the length of vchCryptedKey)                | Master key for wallet encryption. Encrypted using AES-256-CBC.[^4] | `unsigned char` (vchCryptedKey) + `unsigned char[8]` (salt) + `unsigned int` (0 = EVP_sha512[^5] \| 1 = scrypt[^6]) + `unsigned int` (derivation iterations) + `vector<unsigned char> (extra parameters)`                  |
| <span id="CAccountingEntry">`CAccountingEntry`</span> (WIP: src/serialize.h:843)                    | Tracks an internal account transfer.                               | `int64_t` (credit or debit in zatoshis) + `int64_t` (unix timestamp) + `string` (other_account) + '\0' +                                                                                                                   |
| <span id="CBlockLocator">`CBlockLocator`                                                            | A list of current best blocks.                                     | [`vector<uint256>`](#vector) (vector of block hashes)                                                                                                                                                                      |
| <span id="CKeyPool">`CKeyPool`</span> (WIP)                                                         | Pre-generated public key for receiving funds or change.            | [`int64_t`](#int64_t) (key index) + [`CPubKey`](#CPubKey) (public key)                                                                                                                                                     |
...
| <span id="RawHDSeed">`RawHDSeed`</span>                                                             | Hierarchical Deterministic seed.[^2]                               | `unsigned char[32]` (raw HD seed)                                                                                                                                                                                          |
