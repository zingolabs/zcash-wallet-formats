...
| ckey\*               | Encrypted transparent pubkey and private key.                        | `vector<unsigned char>`               | `vector<unsigned char>`                                             |                   |
...
| hdseed\*             | Hierarchical Deterministic seed.                                     | `uint256`                             | `HDSeed`                                                            |                   |
...
| **mkey**             | Master key, used to encrypt public and private keys of the database. | `unsigned int`                        | `CMasterKey`                                                        |                   |
