...
| <span id="CAccountingEntry">`CAccountingEntry`</span>                                               | Tracks an internal account transfer.                                                       | [`int64_t`](#int64_t) (credit or debit in zatoshis) + [`int64_t`](#int64_t) (unix timestamp) + `string` (other_account) + '\0' + [`map`](#map)<`string`, `string`> (metadata) + [`map`](#map)<`string`, `string`> (extra information)       |
...
| <span id="libzcash::SaplingExtendedFullViewingKey">`libzcash::SaplingExtendedFullViewingKey`</span> |                                                                                            | depth + parentFVKTag + childIndex + chaincode + fvk + dk                                                                                                                                                                                    |
