...
| **cscript**          | Serialized script, used inside transaction inputs and outputs. | [`uint160`](#uint160)                                               | [`CScript`](#CScript)                                                                                                                                    |
...
| <span id="prevector">`prevector<N, T>`</span>                                   | Dynamic array of elements of type `T`, optimized for fixed size. | [`CCompactSize`](#CCompactSize) (number of elements) + serialized elements `T` in order.                                            |
...
| <span id="libzcash::diversifier_t">`libzcash::diversifier_t`</span>             |                                                                  | `array<unsigned char>[11]`                                                                                                          |
| <span id="libzcash::diversifier_index_t">`libzcash::diversifier_index_t`</span> | An opaque blob of 88 bits, representing a diversifier index.     | `array<unsigned char>[11]`                                                                                                          |
...
| <span id="CMasterKey">`CMasterKey`</span> (WIP: what is the length of vchCryptedKey)                 | Master key for wallet encryption. Encrypted using AES-256-CBC.[^4]                                                   | `unsigned char` (vchCryptedKey) + `unsigned char[8]` (salt) + [`unsigned int`](#unsigned_int) (0 = EVP_sha512[^5] \| 1 = scrypt[^6]) + `unsigned int` (derivation iterations) + `vector<unsigned char> (extra parameters)`                                                                                                      |
| <span id="CAccountingEntry">`CAccountingEntry`</span>                                                | Tracks an internal account transfer.                                                                                 | `int64_t` (credit or debit in zatoshis) + `int64_t` (unix timestamp) + `string` (other_account) + '\0' + [`map`](#map)<`string`, `string`> (metadata, includes `n` to indicate position) + [`map`](#map)<`string`, `string`> (extra information)                                                                                |
| <span id="CBlockLocator">`CBlockLocator`</span>                                                      | A list of current best blocks.                                                                                       | `vector<uint256>` (vector of block hashes)                                                                                                                                                                                                                                                                                      |
| <span id="CKeyPool">`CKeyPool`</span>                                                                | Pre-generated public key for receiving funds or change.                                                              | `int64_t` (creation time as unix timestamp) + [`CPubKey`](#CPubKey) (public key)                                                                                                                                                                                                                                                |
...
| <span id="SaplingFullViewingKey">`libzcash::SaplingFullViewingKey`</span>                            |                                                                                                                      | `uint256` (ak) + `uint256` (nk) + `uint256` (ovk)                                                                                                                                                                                                                                                                               |
| <span id="SaplingExpandedSpendingKey">`libzcash::SaplingExpandedSpendingKey`</span>                  |                                                                                                                      | `uint256` (ask) + `uint256` (nsk) + `uint256` (ovk)                                                                                                                                                                                                                                                                             |
...
| <span id="SaplingExtendedFullViewingKey">`libzcash::SaplingExtendedFullViewingKey`</span>            |                                                                                                                      | `uint8_t` (depth) + `uint32_t` (parentFVKTag) + `uint32_t` (childIndex) + `uint256` (chaincode) + `libzcash::SaplingFullViewingKey` (fvk) + `uint256` (dk)                                                                                                                                                                      |
| <span id="SaplingExtendedSpendingKey">`libzcash::SaplingExtendedSpendingKey`</span>                  |                                                                                                                      | `uint8_t` (depth) + `uint32_t` (parentFVKTag) + `uint32_t` (childIndex) + `uint256` (chaincode) + `libzcash::SaplingExpandedSpendingKey` (expsk) + `uint256` (dk)                                                                                                                                                               |
| <span id="SaplingPaymentAddress">`libzcash::SaplingPaymentAddress`</span>                            |                                                                                                                      | `diversifier_t` (d) + `uint256` (pk_d)                                                                                                                                                                                                                                                                                          |
| <span id="ReceivingKey">`ReceivingKey`</span>                                                        |                                                                                                                      | `uint256` (sk_enc )                                                                                                                                                                                                                                                                                                             |
| <span id="SproutPaymentAddress">`libzcash::SproutPaymentAddress`</span>                              |                                                                                                                      | `uint256` (a_pk) + `uint256` (pk_enc)                                                                                                                                                                                                                                                                                           |
| <span id="SproutViewingKey">`libzcash::SproutViewingKey`</span>                                      |                                                                                                                      | `uint256` (a_pk) + `libzcash::ReceivingKey` (sk_enc)                                                                                                                                                                                                                                                                            |
| <span id="SproutSpendingKey">`libzcash::SproutSpendingKey`</span>                                    |                                                                                                                      | `uint252` (a_sk)                                                                                                                                                                                                                                                                                                                |
| <span id="CScript">`CScript`</span>                                                                  | Serialized script, used inside transaction inputs and outputs.                                                       | [`prevector`](#prevector)`<28, unsigned char>` (script)                                                                                                                                                                                                                                                                         |
| <span id="SeedFingerprint">`libzcash::SeedFingerprint`</span>                                        |                                                                                                                      | `uint256` (seedFp)                                                                                                                                                                                                                                                                                                              |
...
| <span id="ZcashdUnifiedAccountMetadata">`ZcashdUnifiedAccountMetadata`</span>                        |                                                                                                                      | `libzcash::SeedFingerprint` (seedFp) + `uint32_t` (bip44CoinType) + `libzcash::AccountId` (accountId) + `libzcash::UFVKId` (ufvkId)                                                                                                                                                                                             |
| <span id="ZcashdUnifiedAddressMetadata">`ZcashdUnifiedAddressMetadata`</span>                        |                                                                                                                      | `libzcash::UFVKId` (ufvkId) + `libzcash::diversifier_index_t` (diversifierIndex) + `vector<libzcash::ReceiverType>` (serReceiverTypes)                                                                                                                                                                                          |
| <span id="OrchardWalletNoteCommitmentTreeWriter">`OrchardWalletNoteCommitmentTreeWriter`</span>      |                                                                                                                      | (WIP: Defined in src/rust/src/wallet.rs#L1262)                                                                                                                                                                                                                                                                                  |
