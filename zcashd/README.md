...
| unifiedfvk                   | Encoded unified FVK.         | `libzcash::UFVKId`             | `libzcash::UnifiedFullViewingKey::Encode(string, UnifiedFullViewingKeyPtr) as string` |
...
| <span id="libzcash::SeedFingerprint">`libzcash::SeedFingerprint`</span>                              |                                                                                                                      | `uint256` (seedFp)                                                                                                                                                                                                                                                                                                              |
| <span id="libzcash::AccountId">`libzcash::AccountId`</span>                                          |                                                                                                                      | `uint32_t` (accountId)                                                                                                                                                                                                                                                                                                          |
| <span id="libzcash::UFVKId">`libzcash::UFVKId`</span>                                                | An internal identifier for a unified full viewing key, derived as a blake2b hash of the serialized form of the UFVK. | `uint256` (ufvkId)                                                                                                                                                                                                                                                                                                              |
| <span id="libzcash::ReceiverType">`libzcash::ReceiverType`</span>                                    |                                                                                                                      | `uint32_t` (receiverType, 0 = P2PKH, 1 = P2SH, 2 = Sapling, 3 = Orchard)                                                                                                                                                                                                                                                        |
