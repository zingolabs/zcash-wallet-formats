...
| ckey\*               | [`CPubKey`](#CPubKey)                                               | `vector<unsigned char>` (see [Encryption](#encryption))                                                                                                                           | Encrypted transparent pubkey and private key.                  |
| csapzkey\*           | [`libzcash::SaplingIncomingViewingKey`](#SaplingIncomingViewingKey) | [`libzcash::SaplingExtendedFullViewingKey`](#SaplingExtendedFullViewingKey) (extended full viewing key) + `vector<unsigned char>` (crypted secret, see [Encryption](#encryption)) | Encrypted Sapling pubkey and private key.                      |
...
| **orderposnext**     | -                                                                   | `int64_t` (tied to acentry)                                                                                                                                                       | Index of next tx.                                              |
